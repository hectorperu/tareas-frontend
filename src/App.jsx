...
class App extends React.Component{
  ...
  guardar(e){
    ...
    axios.post('https://hperez-tareaapp.onrender.com/tarea',dataTarea)
    .then(res =>{
  ...
  eliminar(cod){
    axios.delete('https://hperez-tareaapp.onrender.com/tarea/'+cod)
    .then(res=>{
  ...
  componentDidMount(){
    ...
    axios.get('https://hperez-tareaapp.onrender.com/tarea')
    .then(res=>{
      console.log(res.data.content);
      this.setState({
